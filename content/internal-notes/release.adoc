...
2. allows for quick releases when the need arises
3. allows for simple versioning for nightly builds
...
last full release. They happen on a cadence of roughly 6 months.
