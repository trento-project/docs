...
+
image::analytics/create-container.png[Create container]
+

. Get the `Container ID`. This value is used during the `trento-web` artifacts generation.
+
image::analytics/get-id.png[Get ID]
+
...
+
image::analytics/create-tag.png[Create tag] 
image::analytics/set-custom-html.png[Custom HTML] 
+
...
+
image::analytics/create-trigger.png[Create trigger]
image::analytics/all-triggers.png[Triggers] 
+
...
+
image::analytics/prod-tag-triggers.png[Prod triggers] 
image::analytics/test-tag-triggers.png[Test triggers]  
+

The end result should look like this:
+
image::analytics/final-tags.png[Tags]
+
...
image::analytics/github-setup.png[Github CI setup]
