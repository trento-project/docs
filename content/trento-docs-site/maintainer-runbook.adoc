...
If several reviewed user-facing documentation changes already exist on `main` and should move together to the current release without a version bump, follow the partial release update workflow in xref:trento-docs-site/collaboration-docs-team/docs-git-workflow.adoc[Git Workflow for Trento Documentation].
...
Edit `.github/workflows/`, verify the intended behavior against xref:trento-docs-site/ci-and-publishing-overview.adoc[CI and Publishing Overview], and update the related documentation in the same change.
