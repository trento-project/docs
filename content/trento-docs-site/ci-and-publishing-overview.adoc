...
It focuses on workflow triggers, validation, and publication behavior.
For Antora site assembly details, see xref:trento-docs-site/build-pipeline-overview.adoc[Documentation build pipeline overview].
...
For repository ownership, branch roles, and review expectations, see xref:trento-docs-site/collaboration-docs-team/docs-git-workflow.adoc[Git Workflow for Trento Documentation].
