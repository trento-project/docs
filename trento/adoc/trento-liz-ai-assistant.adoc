...
* <<sec-about-liz, About the {liz} AI assistant>>
* <<sec-configuring-liz, Configuring {liz}>>
* <<sec-using-liz, Using {liz}>>

[[sec-about-liz]]
==== About the {liz} AI assistant

{liz} is part of {tr_web} itself and requires no additional deployment. You only need to supply an API key for a <<sec-liz-providers, supported large language model (LLM) provider>>.
...
+
{liz} answers queries using live SAP landscape state from {tr_web}, and check results from {tr_wanda}. 
+
...
* An API key for one of the <<sec-liz-providers, supported providers>>.
