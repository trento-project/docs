...
* *{tr_mcp}* component: running  {tr_web} and  {tr_wanda} components with network connectivity from the MCP Server to the {trserver} API endpoints and a Personal Access Token, created in {tr_web} to authenticate requests from MCP clients.
