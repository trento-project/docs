...
This section describes requirements for the {sap}, {trserver}, {trento-mcp} and its {tragent}s.
...
=== {trento-mcp} requirements 

The {trento-mcp} is an optional component that enables AI-assisted operations via the link:https://modelcontextprotocol.io/introduction[Model Context Protocol] (MCP). It exposes a single HTTP endpoint that MCP-compatible assistants can use to interact with {trento}.
...
=== {trento-mcp} network requirements
