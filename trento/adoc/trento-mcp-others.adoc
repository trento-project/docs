  ...
  "inputs": [
    {
      "type": "promptString",
      "id": "trento-pat",
      "description": "Trento Personal Access Token",
      "password": true
    }
  ]
}
...
* Replace `your-trento-pat` with the API token you generated from your {trento} instance.
