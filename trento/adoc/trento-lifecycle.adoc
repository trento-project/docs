...
Supported runtime::: Supported in {sles4sap} 15 SP4 and newer on x86_64 and ppc64le architectures.
...
systemd deployments::: Supported in {sles4sap} 15 SP4 and newer.
