...
When installing the complete {trserver} using {helm}, the {tr_mcp} is disabled by default. Enable it by passing `--set trento-mcp-server.enabled=true`:
...
The {tr_mcp} endpoint will be: `https://TRENTO_SERVER_HOSTNAME/mcp-server-trento/mcp`
