...
// 
// To get started with the {tr_mcp}, you need to:
// 
...
// 
// For comprehensive instructions, including deployment options and integration with specific AI tools, see <<sec-trento-mcp-how-to-use>>.
// 
