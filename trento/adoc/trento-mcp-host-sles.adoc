...
----
+
.{mcp_host} initial screen with the {tr_mcp} connected
image::mcphost-initial.png[MCPHost initial screen, width=80%,align=center]
...
image::example-mcphost.png[Example MCPHost session with {trento},width=80%,align=center]
