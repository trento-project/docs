...
To configure {mcp_host}, ensure you have:

include::partials/mcp-host-prerequisites.adoc[]

===== Install {mcp_host}

To install {mcp_host}, open a terminal and run:
...
Export your keys in the shell before running {mcp_host}, see this example:
...
** Verify that your personal access token is valid by testing it directly against your {trento} Server API.
