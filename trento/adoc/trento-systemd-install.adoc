...
* <<prometheus-unsupported-packagehub, Install Prometheus on {sles4sap} 15.4 and higher>>
...
====== Install {prometheus} from PackageHub on {sles4sap} 15.x
...
==== Check the health status of {tr_web} and wanda
