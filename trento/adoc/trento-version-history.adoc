...
Version 3.1.0 (released on 2026/XX/YY)::
 Includes {helm} chart 3.1.0, {tr_web} component 3.1.0, orchestration engine ({wanda}) 2.1.0, compliance checks 1.3.0, {mcp} 1.1.0, and {tragent} 3.1.0, with the following highlights:
