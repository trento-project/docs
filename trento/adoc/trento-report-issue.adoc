...
deployment option for {trserver}: {k8s}, or systemd deployment.
...
In case of a systemd deployment, provide the output of the {trento} supportconfig plugin, as explained in section <<sec-trento-problemanalysis>>.
