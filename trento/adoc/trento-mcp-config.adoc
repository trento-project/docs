...
{tr_mcp} allows to override the configuration by using the command line flags. This changes are not persistent and are lost after a change, in order to make these changes persistent, update `/etc/trento/mcp-server-trento` config.
