...
* <<sec-trento-mcp-systemd-config,Configuration in an RPM systemd deployment>>
...
==== Configuration in an RPM systemd deployment
...
.. For systemd/RPM deployments, use `{tr_mcp_binary} --help`
