...
:revdate: 2025-10-31
[[sec-trento-mcp-sles]]
==== Integrating the {tr_mcp} with SLES 16

This guide explains how to connect the {tr_mcp} to {sles} 16 (SLES 16) using MCPHost, a lightweight CLI tool for the Model Context Protocol (MCP).
...
Refer to the official https://github.com/mark3labs/mcphost#installation[MCPHost documentation] for comprehensive configuration details. This section focuses on adding the {tr_mcp} to your system.
...
. *Connection Errors*
** Verify that the {tr_mcp} URL in `~/.mcphost.yml` is correct and accessible from your SLES 16 system.
...
* <<sec-trento-mcp-config>> - For detailed {tr_mcp} configuration reference.
