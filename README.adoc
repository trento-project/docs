...
This repository contains the Trento project documentation that does not interest a specific service, such as ADR, coding standards and best practices, CI workflows, and templates. The xref:./content[*content* directory] is the home of these sources.
 
* xref:./content/architecture/trento-architecture.adoc[Architecture]
* xref:./content/architecture/adr/README.adoc[Architecture Decision Records (ADR)]
* xref:./content/coding-standards/README.adoc[Coding standards]
