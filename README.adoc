...
The CI for the user-facing documentation intentionally mirrors link:https://github.com/SUSE/doc-unversioned[SUSE/doc-unversioned] with small Trento-specific adjustments, which keeps `trento/` compatible with both the docs hub build and the SUSE documentation toolchain.

== Documentation Sources

=== User-Facing Documentation

The link:https://github.com/trento-project/docs/tree/main/trento[`trento`] directory is the single source of truth for Trento user-facing documentation.
...
For example, documentation maintained in link:https://github.com/trento-project/web[`trento-project/web`] is published in the docs hub as link:https://www.trento-project.io/docs/web/README.html[`/docs/web/README.html`].
...
It is built with https://antora.org/[Antora] from the documentation sources described above.
...
It is generated from the user-facing documentation in link:https://github.com/trento-project/docs/tree/main/trento[`trento/`].

=== Published Versions

Two published versions are currently exposed:

* `pre-release` - the version built from the link:https://github.com/trento-project/docs[`main` branch], reflecting the latest state of the project and published at link:https://www.trento-project.io/docs/index.html[`/docs/index.html`]
* `latest: X.X` - the current release version, built from the link:https://github.com/trento-project/docs/tree/latest[`latest` branch] and published at link:https://www.trento-project.io/docs/latest/index.html[`/docs/latest/index.html`]
...
[NOTE]
====
If you are working only in `trento-docs-site/`, you can use the manual Antora workflow described in xref:trento-docs-site/README.adoc[Antora Documentation Site].
====

[IMPORTANT]
====
Docs hub previews consume `trento-docs-site-ui/build/ui-bundle.zip`.
If you changed UI sources in `trento-docs-site-ui/`, rebuild the UI bundle first or the docs hub preview will still use the previous bundle.
====
