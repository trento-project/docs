...
An installation of Trento Server, based on RPM packages or docker images, can be
...
// START OF THE container-install ARTICLE from doc-unversioned
// Check: https://github.com/SUSE/doc-unversioned/tree/main/trento/migration
...
// END OF THE DOCKER INSTALLATION ARTICLE

// Start of the Single Sign on Integration Article
